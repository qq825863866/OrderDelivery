...
using Ods.Repository.Models;
using Ods.Repository.Extensions;
using Ods.Common.Components.Extensions;
using Ods.Repository.DataSeed;

namespace Ods.Repository.Data
{
    public class OdsDbContext : DbContext
    {
        private readonly ICurrentUserService _currentUser;

        public OdsDbContext(DbContextOptions<OdsDbContext> options,
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            MethodInfo configureEntity = typeof(OdsDbContext).GetMethod(
